    ...
    return (
      <div>
        ...
        <Switch>
          ...
          <Route exact path="/general"><News key="general" pageSize={this.page} country="in" category="general" /></Route>
          ...
          <Route exact path="/health"> <News key="health" pageSize={this.page} country="in" category="health" /></Route>
